...
bool Exec::parseFile(std::string filename,std::string method, std::string dataset_size){
    std::cout << "\nInput configuration file: " << filename << std::endl;
    ...
    std::cout << std::endl;
    insertElementInMap("UDL_METHOD", method); //edited by jlx
    insertElementInMap("SIZE_DATASET", dataset_size);
