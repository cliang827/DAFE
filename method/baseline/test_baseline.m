...
reid_score_baseline = cell(para_test_num,1);
auc_score_baseline = cell(para_test_num,1);
feedback_id_baseline = cell(para_test_num,1);
time_result_baseline = cell(para_test_num,1);
switch run_mode
    case 'serial'
        for i=1:para_test_num
            ...
            [reid_score_baseline{i}, auc_score_baseline{i}, feedback_id_baseline{i}, time_result_baseline{i}] = ...
                baseline(dataset_set{i}, feedback_id{i}, baseline_para_set{i}); 
        end
        save(result_file, 'para_test_set', 'eval_para', 'reid_score', 'difficulty_score', 'auc_score', ...
            'feedback_id', 'time_result', 'auc_score_baseline', '-v7.3');
