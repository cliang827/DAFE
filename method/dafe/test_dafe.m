    ...
    case 'serial'
        for i=1:para_test_num
            ...
            fprintf(1,'[%4d/%d] fb_method=''%s'', log(alpha)=%.2f, beta_percentage=%.2f%%, log(gamma)=%.2f, delta=%.2f, fb_num=%d, t=%d\n', ...
                i, para_test_num, ctrl_para_set{i}.model.fb_method, ...
                log10(ctrl_para_set{i}.model.alpha), 100*ctrl_para_set{i}.model.beta_percentage, ...
                log10(ctrl_para_set{i}.model.gamma), ctrl_para_set{i}.model.delta, ...
                ctrl_para_set{i}.model.fb_num, ctrl_para_set{i}.exp.trial);
